...
@InputType()
class InventoryCreateNestedManyWithoutLocationsInput {
...
export { InventoryCreateNestedManyWithoutLocationsInput as InventoryCreateNestedManyWithoutLocationsInput };
